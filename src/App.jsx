...
class App extends React.Component {
    ...
    _startTimer() {
        ...
        this.timerInterval = setInterval(() => {
            this.setState((prevState) => {
                if (prevState.shouldCountDown && prevState.time > 0) {
        ...
        this.setState(
            ...
            () => {
                if (this.state.shouldCountDown) {
                    ...
                    clearInterval(this.timerInterval); // Pause the timer by clearing the interval
                    this.timerInterval = null; // Reset interval reference
    ...
    _pomodoro(totalModeTime, autoStart = false) {
        clearInterval(this.timerInterval); // Clear interval when switching mode
        this.timerInterval = null;
    ...
    render() {
        return (
            <>
                ...
                <footer className="footer-header">• Download <a href="https://github.com/Yagasaki7K/app-pomodoro/raw/main/appomodoro.apk" className="footer__link" target="_blank" rel="noreferrer">Android App (.apk)</a> • <a href="https://github.com/Yagasaki7K/app-pomodoro/raw/main/appomodoro.msi" className="footer__link" target="_blank" rel="noreferrer">Windows App (.msi)</a> • <a href="https://github.com/Yagasaki7K/app-pomodoro/raw/main/appomodoro.deb" className="footer__link" target="_blank" rel="noreferrer">Linux App (.deb)</a> •</footer>
            </>
        )
    }
}
